 ...
 * it), and asserts the host-facing `beam-accounts:mint-key` command is wired and mints a
...
class KeysModuleEnabledTest extends Orchestra
{
    ...
    {
        $this->assertArrayHasKey('beam-accounts:mint-key', $this->app[Kernel::class]->all());
    }

    public function test_command_mints_a_deterministic_row(): void
    {
        $this->artisan('beam-accounts:mint-key', [
            'id' => 990003,
